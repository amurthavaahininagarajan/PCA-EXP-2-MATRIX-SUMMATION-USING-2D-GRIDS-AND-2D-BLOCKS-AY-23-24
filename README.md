...
## OUTPUT:
## FLOAT
![image](https://github.com/amurthavaahininagarajan/PCA-EXP-2-MATRIX-SUMMATION-USING-2D-GRIDS-AND-2D-BLOCKS-AY-23-24/assets/118679102/704ee90f-857a-41ca-84c7-344fbc8420f6)
## INT:
![image](https://github.com/amurthavaahininagarajan/PCA-EXP-2-MATRIX-SUMMATION-USING-2D-GRIDS-AND-2D-BLOCKS-AY-23-24/assets/118679102/b13624d6-1230-4ac0-b7cb-4d81d3535530)


## RESULT:
The host took 0.896071 seconds to complete it’s computation, while the GPU outperforms the host and completes the computation in  0.013690 seconds. Therefore, float variables in the GPU will result in the best possible result. Thus, matrix summation using 2D grids and 2D blocks has been performed successfully.
